...
public class Spoofing extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mUpdateJsonButton.setOnPreferenceClickListener(preference -> {
            updatePropertiesFromUrl("https://raw.githubusercontent.com/AresOS-AOSP/PlayIntegrityFix/refs/heads/main/pif_new.json");
            return true;
        });
    ...
    private boolean isCurrentlySupportedPixel() {
